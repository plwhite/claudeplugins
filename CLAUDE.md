...
`internal-docs-prune` completed 2026-07-25 — added prevention rules and a `/internal-docs-prune` cleanup tool (with a read-only `internal-docs-reviewer` agent) for the internal, Claude-facing docs that grow append-only (#46). See `features/COMPLETED.md` for detail.
