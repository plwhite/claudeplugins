...
If design or architecture documentation exists (CLAUDE.md, README.md, features/plans/, or contents of docs directories), read the relevant sections to assess consistency with stated intent.
