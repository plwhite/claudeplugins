...
- `code-review-architectural` — checks module boundaries, coupling, and design fit; also pass any relevant design/architecture documents (README.md, CLAUDE.md, features/plans/)
